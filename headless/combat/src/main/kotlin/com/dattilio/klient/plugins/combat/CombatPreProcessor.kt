...
class CombatPreProcessor(
    val combatSettings: CombatSettings, override val coroutineContext: CoroutineContext
) : CoroutineScope {
    ...
    private val parser = CombatParser(combatSettings, state.stateMachine)
...
//        view.engagedText.text = stringBuilder.toString()
    ...
    private fun sendCommand(
        command: String,
        failureEvent: CombatStateMachine.Event?,
