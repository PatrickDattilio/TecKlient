...
import com.dattilio.klient.headless.courses.CoursesStateMachine.Event.*
import com.tinder.StateMachine

class CoursesParser(
    private val stateMachine: StateMachine<CoursesStateMachine.State, CoursesStateMachine.Event, CoursesStateMachine.SideEffect>
) {
...
//            }
            ...
            "You stand up" in line -> stateMachine.transition(StandSuccess)
